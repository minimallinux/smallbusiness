...
class ACF {
	...
	*/
	...
	function register_assets() {
		...
		$my_theme = get_template_directory_uri().'/npm/advanced-custom-fields-pro/';
	

		// scripts
		wp_register_script('acf-input', "{$my_theme}assets/js/acf-input{$min}.js", array('jquery', 'jquery-ui-core', 'jquery-ui-sortable', 'jquery-ui-resizable'), $version );
		wp_register_script('acf-field-group', "{$my_theme}assets/js/acf-field-group{$min}.js", array('acf-input'), $version );
		
		
		// styles
		wp_register_style('acf-global', "{$my_theme}assets/css/acf-global.css", array(), $version );
		wp_register_style('acf-input', "{$my_theme}assets/css/acf-input.css", array('acf-global'), $version );
		wp_register_style('acf-field-group', "{$my_theme}assets/css/acf-field-group.css", array('acf-input'), $version );		
