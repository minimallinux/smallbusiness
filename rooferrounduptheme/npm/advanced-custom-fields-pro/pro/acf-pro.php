...
class acf_pro {
	...
	*/
	...
	function register_assets() {
		...
		// register scripts
		wp_register_script( 'acf-pro-input', "{$my_theme}pro/assets/js/acf-pro-input{$min}.js" , array('acf-input'), $version );
		wp_register_script( 'acf-pro-field-group', "{$my_theme}pro/assets/js/acf-pro-field-group{$min}.js" , array('acf-field-group'), $version );
		
		
		// register styles
		wp_register_style( 'acf-pro-input', "{$my_theme}pro/assets/css/acf-pro-input.css", array('acf-input'), $version ); 
		wp_register_style( 'acf-pro-field-group', "{$my_theme}pro/assets/css/acf-pro-field-group.css", array('acf-input'), $version ); 
